...
class DirectoryEntry {
  public:
    ...
    char name[FileNameMaxLen + 1];	// Text name for file, with +1 for 
					// the trailing '\0'
	bool type;		// 1 for dir, 0 for file
...
class Directory {
  public:
    ...
    bool Add(char *name, int newSector, bool type, char *parent);  // Add a file name into the directory

    bool Remove(char *name);		// Remove a file from the directory

    void List(char *parent, bool recursive);			// Print the names of all the files
					//  in the directory
