...
int
Interrupt::Write(int buf_add, int buf_size, int tid)
{
	return kernel->Write(buf_add, buf_size, tid);
}
int
Interrupt::Read(int buf_add, int buf_size, int tid)
{
	return kernel->Read(buf_add, buf_size, tid);
}
int
Interrupt::Close(int deleteid)
{
	return kernel->Close(deleteid);
}
//----------------------------------------------------------------------
// Interrupt::Schedule
